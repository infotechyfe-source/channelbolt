...
const AnalyticsSection = () => {
  return (
    <section className="bg-[#0B0F19] text-white pb-20 pt-4 px-4 md:px-8 lg:px-16 font-sans border-t border-gray-900">
      <div className="max-w-7xl mx-auto">
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Left Column: Analytics & Progress Bars (Span 7) */}
          <div className="lg:col-span-7 bg-[#131927] p-8 rounded-3xl border border-gray-800">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
             {/* Certification Grid */}
             <div className="bg-[#131927] p-8 rounded-3xl border border-gray-800">
